...
- **[Block Diffusion](https://arxiv.org/abs/2503.09573)** — Arriola et al. (ICLR 2025). The source of LLaDA2.0-Uni's BDLM loss and block-wise attention pattern. Formal framework for interpolating between AR and diffusion language models.
