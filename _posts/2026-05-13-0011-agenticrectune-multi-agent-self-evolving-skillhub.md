...
- **Conference template 미정리**. 학회 발표 논문이 아니라 preprint 임에도 헤더에 "Conference acronym 'XX, June 03–05, 2018, Woodstock, NY" 가 그대로 남아 있고 reference 의 일부 인용 (예: [4, 7] of Compositional Optimization references) 이 generic 한 reference 로 빠진 흔적이 있다. *논문 자체의 폴리시* 측면에서 *production team 의 보고서를 학회 형식으로 옮긴 단계* 라는 인상.
